...
<div class="container">
    ...
    <h1 class="title">Silahkan Isi Form Yang Ada ( Komisi Pria )</h1>

    <form action="/pria/store" method="POST">
        @csrf
        <div class="container mt-3">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="nama_istri" id="tanggalLahirInput" class="form-control" placeholder="tanggal lahir" style="background-color:black; color:white;">
                </div>
            </div>
