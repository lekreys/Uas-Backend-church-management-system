...
<h1 class="title">Anggota Komisi Pria Pouk Bojong Indah</h1>
<hr style="color:white">


<div class="fitur" style="display:flex">

    <a href="/pria/create"><button type="button" class="btn btn-outline-success">Tambah Anggota Komisi Pria</button></a>

    <!-- Form Pencarian dan Filter di Pojok Kanan Atas -->
    <div style="text-align: right; margin-left:50%; margin-bottom: 20px;">
        <form method="GET" action="{{ route('pria.search') }}" style="display: inline-block;">
...
<table class="table-custom">
    ...
    @foreach($pria as $u)
        ...
        <tr  style="border-bottom :  1px white solid">
            ...
            <td>
                <a href="/pria/{{$u->id}}/edit">edit</a>

                <form action="/pria/{{$u->id}}" method="POST">
                    @csrf
                    @method('delete')
