...
<h1 class="title">Silahkan Isi Form Yang Ada ( Penginjilan )</h1>
    
    <form action="/penginjilan/store" method="POST">
        @csrf
        <div class="container mt-3">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="komisi_asal" id="tanggalLahirInput" class="form-control" placeholder="tanggal lahir" style="background-color:black; color:white;">
                </div>
            </div>
